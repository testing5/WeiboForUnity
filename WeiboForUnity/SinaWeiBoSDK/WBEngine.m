...
#define kWBSDKDemoAppKey @"1105863339"
#endif

#ifndef kWBSDKDemoAppSecret
#define kWBSDKDemoAppSecret @"e8164e1f46f0d146eaf9da3c74f12bb0"
#endif
...
static WBEngine *singleEngine = nil;

+ (WBEngine *)sharedEngine
{
    if (!singleEngine) {
        singleEngine = [[WBEngine alloc]initWithAppKey:kWBSDKDemoAppKey appSecret:kWBSDKDemoAppSecret];
        //[singleEngine setRootViewController:self];
        //[singleEngine setDelegate:self];
        [singleEngine setRedirectURI:@"http://localhost.com"];
        [singleEngine setIsUserExclusive:NO];
    }
    return singleEngine;
}
